...
// El control de acceso vive en page.tsx (server component), que valida
// el rol contra la sesión antes de renderizar esto. Aquí no se comprueba
// nada: un guard de cliente es una sugerencia, no una defensa.
